    ...
    def parse_category(self, response):
        ...
        try:
            ...
            for article in articles:
                ...
                self.logger.debug(f"URL exists in DB: {exists}")
                ...
                if not exists:
                    ...
                    articles_added += 1
                    response.meta['article_count'] += 1
        finally:
            session.close()

        self.logger.debug(f"=== END Category {response.meta['category_id']}, Added {articles_added} articles ===")
